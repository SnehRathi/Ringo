...
const { sendMessage } = require('./controllers/messageController'); // Only import sendMessage now
...
io.on('connection', (socket) => {
  ...
  socket.on('sendMessage', async (message) => {
    ...
    try {
      const savedMessage = await sendMessage({ ...message, io }); // Call sendMessage controller
