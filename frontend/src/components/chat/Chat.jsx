...
import { addPendingMessage, addMessage } from '../../redux/messagesSlice';
...
function Chat() {
    ...
    const handleFileChange = (e) => {
        ...
        if (selectedFiles.length > 0) {
            setFile(selectedFiles); // Set all selected files to state
    ...
    const sendMessage = async () => {
        if (file && file.length > 0) {
            ...
            setFile([]); // Clear all files after sending
            setFileType([]);
